<script>
    $(function() {
        ...
        $('#edit-modal').on('show.bs.modal', function(event) {
            ...
            $.get('/admin/link/' + route + '/' + id + '/edit', function(html) {
                $('#ajax-modal-body').html(html);
            })
        })

        $(document).on('submit', '#store-banner-form', function(e) {
            e.preventDefault();

            let form = $(this),
                formData = new FormData(this);

            new linkInsert(form, formData);
        })

        $(document).on('submit', '.update-banner-form', function(e) {
            e.preventDefault();
        ...
        $(document).on('submit', '#store-jdih-form', function(e) {
            e.preventDefault();
        ...
        $(document).on('submit', '.update-jdih-form', function(e) {
            e.preventDefault();
        ...
        $(document).on('submit', '#store-youtube-form', function(e) {
            e.preventDefault();
        ...
        $(document).on('submit', '.update-youtube-form', function(e) {
            e.preventDefault();
    ...
    function linkInsert(element, data) {
        $.ajaxSetup({
            headers: {
                'X-CSRF-Token': $('meta[name="csrf-token"]').attr('content')
            }

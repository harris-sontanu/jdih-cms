...
@section('content')
    ...
    <div class="content pt-0">
        ...
        <!-- Form -->
        <form method="POST" action="{{ route('admin.news.store') }}" novalidate enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-8 offset-lg-2">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="body" class="form-control @error('body') is-invalid @enderror" id="ckeditor_body"></textarea>
                                    @error('body')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="excerpt" class="form-control @error('excerpt') is-invalid @enderror" id="ckeditor_excerpt"></textarea>
                                    @error('excerpt')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <table class="table table-borderless my-2 table-xs">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <input type="text" class="form-control datetimerange-single text-end @error('published_at') is-invalid @enderror" name="published_at" value="{{ old('published_at', now()->translatedFormat('d-m-Y H:i')) }}">
                                            @error('published_at')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </td>

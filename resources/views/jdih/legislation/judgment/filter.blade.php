...
<div class="card shadow-lg">
    ...
    <div class="sidebar-section-body pt-0">
        <form class="filter-form" action="{{ route('legislation.monograph.index') }}" method="get">
            ...
            <div class="mb-3">
                <label for="code_number" class="d-block form-label fw-semibold">Nomor Putusan</label>
                <input type="text" name="code_number" id="code_number" class="form-control"
                    placeholder="Contoh: 319 PK/Pdt/2016" value="{{ Request::get('code_number') }}">
            </div>
            ...
            <div class="mb-3">
                <label for="justice" class="d-block form-label fw-semibold">Jenis Peradilan</label>
                <input type="text" name="justice" id="justice" class="form-control"
                    placeholder="Contoh: Pengadilan Agama" value="{{ Request::get('justice') }}">
            </div>

            <div class="mb-3">
                <label for="place" class="d-block form-label fw-semibold">Tempat Peradilan</label>
                <input type="text" name="place" id="place" class="form-control"
                    placeholder="Contoh: Denpasar" value="{{ Request::get('place') }}">
            </div>

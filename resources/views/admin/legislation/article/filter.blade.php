<div class="card-body bg-light pb-0">
    <form action="{{ route('admin.legislation.article.index') }}" id="filter-form" class="filter-form" method="GET">
        <div class="row">
            <div class="col-md-3">
                <div class="mb-3">
            ...
            <div class="col-md-3">
                <div class="mb-3">
                    <input type="number" class="form-control" placeholder="Tahun" name="year" value="{{ Request::get('year') }}">
                </div>
            </div>
            <div class="col-md-3">
                <div class="mb-3">

                            ...
                            <div class="form-control-feedback form-control-lg form-control-feedback-start flex-grow-1">
                                ...
                                <div class="dropdown-menu w-100">
                                    ...
                                    <div class="dropdown-menu-scrollable-lg">
                                        ...
                                        <div class="dropdown-item cursor-pointer">
                                            <div class="me-3">
                                                <img src="{{ asset('assets/admin/images/brands/adobe.svg') }}" class="w-32px h-32px rounded-pill" alt="">
                                            </div>
                                        ...
                                        <div class="dropdown-item cursor-pointer">
                                            <div class="me-3">
                                                <img src="{{ asset('assets/admin/images/brands/holiday-inn.svg') }}" class="w-32px h-32px rounded-pill" alt="">
                                            </div>
                                        ...
                                        <div class="dropdown-item cursor-pointer">
                                            <div class="me-3">
                                                <img src="{{ asset('assets/admin/images/brands/ing.svg') }}" class="w-32px h-32px rounded-pill" alt="">
                                            </div>

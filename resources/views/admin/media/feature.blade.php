            ...
            <div class="dropdown-menu dropdown-menu-right">
                <div class="dropdown-submenu dropdown-submenu-start">
                    ...
                    <div class="dropdown-menu">
                        <a href="#" class="dropdown-item trigger" data-route="/admin/media/trigger" data-type="{{ $type }}" data-action="publication" data-val="publish">Tayang</a>
                        <a href="#" class="dropdown-item trigger" data-route="/admin/media/trigger" data-type="{{ $type }}" data-action="publication" data-val="unpublish">Tidak Tayang</a>
                    </div>
                </div>
                <div class="dropdown-divider"></div>
                <a href="#" class="dropdown-item trigger" data-route="/admin/media/trigger" data-type="{{ $type }}" data-confirm="Apakah Anda yakin menghapus {{ $type }}?" data-action="delete">Hapus</a>
            </div>
        </div>

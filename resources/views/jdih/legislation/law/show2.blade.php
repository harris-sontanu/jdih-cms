    ...
    <div class="content-wrapper">
        ...
        <main class="content row">
            <div class="col-xl-10 offset-xl-1">
                <div class="row gx-5">
                    <div class="col-xl-3">
                        <img @isset ($legislation->masterDocumentSource) data-pdf-thumbnail-file="{{ $legislation->masterDocumentSource }}" @endisset src="{{ $legislation->coverThumbSource }}" alt="{{ $legislation->title }}" class="img-fluid rounded shadow-lg">
                    ...
                    <div class="col-xl-9">
                        <div class="card p-3 shadow-lg">
                            <div class="card-header border-bottom-0">
                                ...
                                <ul class="post-meta list-inline list-inline-bullet text-muted fs-lg">

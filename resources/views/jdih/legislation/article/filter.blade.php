...
<div class="card shadow-lg">
    ...
    <div class="sidebar-section-body pt-0">
        <form class="filter-form" action="{{ route('legislation.article.index') }}" method="get">
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="source" class="d-block form-label fw-semibold">Sumber</label>
                <input type="text" name="source" id="source" class="form-control"
                    placeholder="Contoh: Majalah Hukum" value="{{ Request::get('source') }}">
            </div>

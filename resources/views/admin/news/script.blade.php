    ...
    $(function() {
        ...
        if (typeof CKEDITOR !== 'undefined') {
            CKEDITOR.ClassicEditor.create(document.getElementById("ckeditor_body"), {
                ...
                placeholder: 'Ketik detail informasi berita yang ingin disampaikan.',
            ...
            CKEDITOR.ClassicEditor.create(document.getElementById("ckeditor_excerpt"), {
                ...
                placeholder: 'Ketik bagian pembuka atau potongan singkat dari isi berita.',
                removePlugins: [
                    // These two are commercial, but you can try them out without registering to a trial.
                    // 'ExportPdf',
                    // 'ExportWord',
